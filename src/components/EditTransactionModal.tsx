...
export function EditTransactionModal({ open, onClose, onUpdate, transaction }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!desc || !amount || !category || !transaction) return;
    setSaving(true);
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-semibold tracking-tight text-foreground dark:text-white mb-6">Editar Transação</h2>
